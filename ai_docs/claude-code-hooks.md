...
> **⚠️ WARNING**: Hooks execute shell commands with your full user permissions without
...
> **Note**: `"matcher": "*"` is invalid. Instead, omit "matcher" or use `"matcher": ""`.
...
Claude Code hooks work seamlessly with Model Context Protocol (MCP) tools. When MCP servers
